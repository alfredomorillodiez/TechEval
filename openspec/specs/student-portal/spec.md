...
El sistema SHALL exponer un endpoint que devuelva, para el alumno autenticado, el listado de sus `ExamResult` (título del examen, porcentaje obtenido, si aprobó, y fecha de finalización), ordenados del más reciente al más antiguo, sin exponer nunca resultados de otro alumno.

#### Scenario: Alumno con historial de resultados
- **GIVEN** un alumno autenticado con tres `ExamResult` asociados a su `UserId`
