...
- [ ] 10.3 Crear una pregunta manualmente y confirmar que queda disponible de inmediato para selección — pendiente de verificación manual en navegador (requiere login de administrador)
- [ ] 10.4 Generar una prueba desde `/admin/pruebas/generate` y confirmar que sigue seleccionando preguntas aleatoriamente de la BD por categoría/dificultad — ruta `POST /api/exams/generate` confirmada presente y sin cambios en el contrato; falta la pasada manual end-to-end en navegador
